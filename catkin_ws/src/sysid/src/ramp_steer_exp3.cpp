...
int main(int argc, char **argv)
{
    ...
    outfile.open("/home/nvidia/Desktop/Sysid/ramp_steer_exp3_trial0.csv");
    ...
    for(int steering_ang_deg = -30; steering_ang_deg <= 0 && ros::ok() ; steering_ang_deg ++)
    {
        ...
        cmd_pub.publish(cmd);
        ROS_INFO("ramp_steer_exp3: Running at steering angle %d degrees.\n", steering_ang_deg);
        ROS_INFO("ramp_steer_exp3: Running at forward velocity %lf .\n", forward_vel);
