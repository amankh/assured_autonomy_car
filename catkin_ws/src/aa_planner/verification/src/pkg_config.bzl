# 
# Based on tools/workspace/pkg_config.bzl from https://github.com/RobotLocomotion/drake/
#
# Modified by: Michael A Warren <mawarren@hrl.com>, Akeksey Nogin <anogin@hrl.com>
# Copyright (C) HRL Laboratories, LLC 2018
...
_DEFAULT_TEMPLATE = Label("//src:pkg_config.BUILD.tpl")
...
def setup_pkg_config_repository(repository_ctx):
    ...
    result = _run_pkg_config(repository_ctx, args + ["--exists"])
