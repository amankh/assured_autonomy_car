...
int main(int argc, char **argv)
{
    ...
    outfile.open("/home/nvidia/Desktop/Sysid/circle_exp5_trial1.csv");
    ...
    ROS_INFO("circle_exp1: steering offset %lf .\n", steering_offset);
    ROS_INFO("circle_exp1: steering gain %lf .\n", steering_gain);
